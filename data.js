...
let providersData = [
    ...
    { id: 104, serviceId: 1, name: 'Ojimba Munachi Precious (Nexora Group)', location: 'Awka', price: 5000, rating: 5.0, photo: 'provider-sarah.png', about: 'Professional cleaning, laundry, cooking and errand services.', jobs: 0 },
    { id: 105, serviceId: 14, name: 'Okeke Ebuka Paul (AmarClean)', location: 'Awka', price: 3000, rating: 5.0, photo: 'provider-sarah.png', about: 'Professional laundry services.', jobs: 0 },
    ...
    { id: 108, serviceId: 13, name: 'Godsfavour Ibekwe (Mma Signature)', location: 'Ifite', price: 4500, rating: 5.0, photo: 'provider-sarah.png', about: 'Professional hairstyling and grooming.', jobs: 0 },
    { id: 109, serviceId: 12, name: 'Ude Michael Ukpai (Doclux Paints)', location: 'Enugu', price: 10000, rating: 5.0, photo: 'provider-sarah.png', about: 'Paint sales and professional painting services.', jobs: 0 },
    { id: 110, serviceId: 18, name: 'Winner Arema (Alpha Tech)', location: 'Item 7, Awka', price: 7500, rating: 5.0, photo: 'provider-sarah.png', about: 'Interior decoration, furniture and electrical services.', jobs: 0 },
    { id: 111, serviceId: 2, name: 'Mbah ThankGod Arinze (J-vic)', location: 'PH', price: 8000, rating: 5.0, photo: 'provider-sarah.png', about: 'Expert plumbing services and repairs.', jobs: 0 },
    { id: 112, serviceId: 12, name: 'Chinedu Samuel Nweke (Edu Painting)', location: 'Awka', price: 100000, rating: 5.0, photo: 'painting_edu_1.png', about: 'Professional screeding, painting, and cleaning services for residential and commercial properties. Price Range: ₦100,000 - ₦2,700,000.', portfolio: ['painting_edu_1.png', 'painting_edu_2.png', 'painting_edu_3.png', 'painting_edu_4.png'], jobs: 0 },
    { id: 113, serviceId: 2, name: 'Edeh Nicodemus Ejiofor (Prosper Plumbing)', location: 'Awka', price: 8500, rating: 5.0, photo: 'provider-sarah.png', about: 'Plumbing and building toilet installations.', jobs: 0 },
    { id: 114, serviceId: 17, name: 'Obum Chisom Samuel (Chim-som Logistics)', location: 'Awka', price: 2000, rating: 5.0, photo: 'provider-sarah.png', about: 'Efficient errands and logistics services.', jobs: 0 },
    { id: 115, serviceId: 1, name: 'Umeadi Mary Chiemelie (Thrillers Cleaning)', location: 'Amaenyi', price: 5000, rating: 5.0, photo: 'provider-sarah.png', about: 'House cleaning, deep cleaning, post construction cleaning, and offices and homes cleaning.', jobs: 0 },
    { id: 116, serviceId: 2, name: 'Uzoechie Chizoba Hillary', location: 'Ifite', price: 7500, rating: 5.0, photo: 'provider-sarah.png', about: 'Professional plumbing work.', jobs: 0 },
    { id: 117, serviceId: 14, name: 'Omeni Victor (Diamond Laundry)', location: 'Ifite', price: 3500, rating: 5.0, photo: 'provider-sarah.png', about: 'Quality dry cleaning and laundry services.', jobs: 0 },
    { id: 118, serviceId: 11, name: 'Chiemerie Ozokolo (MP Carpenter)', location: 'Ifite', price: 60000, rating: 5.0, photo: 'furniture_mp_1.png', about: 'Expert Furniture Craft & Interior. Products: \n- Standard 4/6 Bedframes (60" head, 18" rails): 150k - 250k\n- Luxury 4/6 Bedframes: 250k - 350k\n- Kitchen Cabinets (with Marble): 60k - 100k', portfolio: ['furniture_mp_1.png', 'furniture_mp_2.png', 'furniture_mp_3.png'], jobs: 0 },
    { id: 119, serviceId: 6, name: 'Chibueze Nwoka (Kingz Engineering & Tech)', location: 'Awka', price: 8000, rating: 5.0, photo: 'provider-sarah.png', about: 'Electrical, Solar and Smart home tech.', jobs: 0 },
    { id: 120, serviceId: 12, name: 'Amaifeobu Miracle C. (Albagreat Consortium)', location: 'Obosi', price: 12000, rating: 5.0, photo: 'provider-sarah.png', about: 'Paint production, painting, and house cleaning services.', jobs: 0 },
    { id: 121, serviceId: 11, name: 'Obot Daniel Sylvester (Dnl Furnitures)', location: 'Ifite', price: 7000, rating: 5.0, photo: 'provider-sarah.png', about: 'Custom furniture and interior design.', jobs: 0 },
    { id: 122, serviceId: 1, name: 'Ezezike Hope Chinonso (Hopecee)', location: 'Awka', price: 4500, rating: 5.0, photo: 'provider-sarah.png', about: 'Cleaning services and errand runs.', jobs: 0 },
    { id: 123, serviceId: 1, name: 'Jessyca Udeogu (Ssyca)', location: 'Udoka', price: 5000, rating: 5.0, photo: 'provider-sarah.png', about: 'Professional cleaning services.', jobs: 0 },
    { id: 124, serviceId: 13, name: 'Emelobe Ijeoma Shalom (Hair by Shalom)', location: 'Ifite', price: 5000, rating: 5.0, photo: 'provider-sarah.png', about: 'Braiding, weaving, lashes and locs.', jobs: 0 },
    { id: 125, serviceId: 1, name: 'Chinyere Okeke (3CCLEANING & Errand Services)', location: 'Asaba', price: 6000, rating: 5.0, photo: 'provider-sarah.png', about: 'Household cleaning, maintenance, and post construction cleaning services.', jobs: 0 },
